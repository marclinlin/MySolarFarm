...
public class P9Activity_a extends AppCompatActivity {

    private ProgressBar progressBar;
    private asynctask asynctask;
    private String title, carga, nombpla, nombbat, inc1;
    ...
    private int i,j;
    private double term1, term2, term3, term4, term5, minhsp,inclopt;
    private double a0,a1,k,a0i,a0v,a1i,a1v,ki,kv, altitude,lat, ori, inc, pcabl, pconv, pbat, enec, etperd, pplaca, cplaca, vsis, pserie,pparal, pinst, lvert, lhori, dhor, sup, dauto, pdes;
    private double vbat, capbat, cbat, batserie, batparal, pinv, pnec, cinv, fsim, pvol, pint, creg, vplaca, prepla, prebat;
    private double omes1,omes2,omes3,omes4,omes5,omes6,omes7,omes8,omes9,omes10,omes11,omes12;
    private double mnpan, menergiamasperd, mmeses, mminhsp;
    ...
    private class asynctask extends AsyncTask<Void,Integer,Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            for (m = 20; m <= 65; m++) {
                ...
                for (p=0;p<=11;p++) {
                    ...
                    if (numeropaneles[p]>mnpan){
                        mnpan=numeropaneles[p];
                        menergiamasperd=energiamasperd[p];
                        mmeses=meses[p];
                    }
                }
            ...
            dhor=(lvert*Math.sin(Math.toRadians(inclopt)))/Math.tan(Math.toRadians(61)-latitud);
            sup=(filpan-1)*dhor*lhori*Math.ceil(npan/filpan)+npan*lhori*lvert*Math.cos(Math.toRadians(inclopt));
            ...
            //Formatear variables
            String a26 = String.format(Locale.US, "%.2f", inclopt);
            String a41 = String.format(Locale.US, "%.2f", omes1);
            String a42 = String.format(Locale.US, "%.2f", omes2);
            String a43 = String.format(Locale.US, "%.2f", omes3);
            String a44 = String.format(Locale.US, "%.2f", omes4);
            String a45 = String.format(Locale.US, "%.2f", omes5);
            String a46 = String.format(Locale.US, "%.2f", omes6);
            String a47 = String.format(Locale.US, "%.2f", omes7);
            String a48 = String.format(Locale.US, "%.2f", omes8);
            String a49 = String.format(Locale.US, "%.2f", omes9);
            String a50 = String.format(Locale.US, "%.2f", omes10);
            String a51 = String.format(Locale.US, "%.2f", omes11);
            String a52 = String.format(Locale.US, "%.2f", omes12);
        ...
        protected void onPostExecute (Boolean result){
            if (result) {
                Intent intent = new Intent(P9Activity_a.this, P10Activity.class);
